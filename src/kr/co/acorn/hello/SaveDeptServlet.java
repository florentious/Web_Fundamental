...
import kr.co.acorn.hello.dao.DeptDao;
import kr.co.acorn.hello.dto.DeptDto;
...
public class SaveDeptServlet extends HttpServlet{
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(isSuccess) {
			response.sendRedirect("/Practice/dept_success.html");
			
		}else {
			response.sendRedirect("/Practice/dept.html");
		}
